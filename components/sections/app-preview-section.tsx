      ...
      <div className="bd-container">
        <div className="text-center">
          ...
          <h2 className="bd-heading mt-4">
            Alt om dine cykler --{" "}
            <span className="bd-heading-accent">samlet et sted</span>
          </h2>
          <p className="bd-body mx-auto mt-3 max-w-xl">
            Med en Serviceaftale far du adgang til din personlige dashboard. Se
            dine cykler, book direkte, og chat med din cykelsmed.
          </p>
        </div>
        ...
        <div className="mx-auto mt-14 max-w-4xl">
          ...
          <div className="overflow-hidden rounded-2xl bg-card shadow-sm">
            ...
            <div className="grid divide-y divide-secondary sm:grid-cols-2 sm:divide-x sm:divide-y-0">
              {/* Left: Mechanic card */}
              <div className="p-6">
                ...
                <div className="mt-4 flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-bold text-foreground">Mikkel S.</p>
                ...
                <button
                  type="button"
                  className="mt-4 flex w-full items-center justify-center gap-2 rounded-full bg-accent/10 px-4 py-3 text-sm font-medium text-accent transition-colors hover:bg-accent/20"
                >
              ...
              <div className="p-6">
                ...
                <button
                  type="button"
                  className="mt-4 flex w-full items-center justify-center gap-2 rounded-full bg-background px-4 py-3 text-sm font-medium text-foreground transition-colors hover:bg-secondary"
                >
