...
export const BLOCKS: Block[] = [
...

  {
    ...
    ownerNotes: "Reviews section deferred to v2 phase (needs real review data). All other MVP sections built.",
    files: [
      { path: "components/sections/hero-section.tsx", status: "done", notes: "Navy bg, h1/subheadline from DB, coral CTA, trust pills, dot pattern" },
      { path: "components/sections/trust-bar.tsx", status: "done", notes: "4 trust signals: rating, repairs count, same-day, guarantee" },
      { path: "components/sections/how-it-works.tsx", status: "done", notes: "3-step cards: Book -> We come -> Fixed" },
      { path: "components/sections/services-grid.tsx", status: "done", notes: "Server component, fetches service_catalog, grouped by category, prices" },
      { path: "components/sections/bike-types-grid.tsx", status: "done", notes: "Server component, fetches bike_types, icon per type, links to /[slug]-reparation" },
      { path: "components/sections/reviews-section.tsx", status: "deferred-v2", notes: "Needs real review data -- placeholder in page-templates.ts" },
      { path: "components/sections/faq-section.tsx", status: "done", notes: "Client component, accordion with animated open/close" },
      { path: "components/sections/cta-banner.tsx", status: "done", notes: "Navy bg, coral CTA, heading/subtext" },
    ],
    acceptanceCriteria: [
      { id: "1.1-a", description: "Hero with h1 from DB, compelling subtext, prominent Book nu CTA", met: true },
      { id: "1.1-b", description: "Trust bar with 3+ trust signals (mobile, certified, same-day)", met: true },
      { id: "1.1-c", description: "How it works: 3-step visual flow", met: true },
      { id: "1.1-d", description: "Services grid: cards with prices from Supabase, grouped by category", met: true },
      { id: "1.1-e", description: "Bike types grid from DB", met: true },
      { id: "1.1-f", description: "FAQ section with accordion, content from page_content.faqs", met: true },
      { id: "1.1-g", description: "All sections responsive: 375px, 768px, 1280px", met: true },
      { id: "1.1-h", description: "CTA buttons trigger booking overlay with correct preset from page_content", met: true },
    ],
    dependsOn: ["0.3"],
